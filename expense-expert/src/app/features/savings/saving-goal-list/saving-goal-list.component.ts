      ...
      @for (goal of goals; track goal.id) {
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 flex flex-col justify-between">
          <div class="flex flex-col gap-4 mb-4">
            <div class="min-w-0">
              <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100 capitalize">{{ goal.purpose }}</h3>
              <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mt-1.5">
...
export class SavingGoalListComponent {
  ...
  @Output() withdraw = new EventEmitter<SavingGoal>();
