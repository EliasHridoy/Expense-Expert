...
@Component({
  ...
  template: `
    ...
    @if (isLoading()) {
      ...
      <!-- Bank Accounts -->
      <div class="mb-8">
        <h2 class="text-sm font-semibold text-gray-700 mb-3">Bank Accounts</h2>
      ...
      <div class="mb-8">
        <h2 class="text-sm font-semibold text-gray-700 mb-3">Saving Goals</h2>
      ...
      <div class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="relative bg-white rounded-xl shadow-xl p-6 max-w-sm w-full mx-4">
          ...
          <input
            ...
            min="1"
            placeholder="Amount"
            class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none mb-3"
          />
          <input
            [(ngModel)]="saveNote"
            placeholder="Note (optional)"
            class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none mb-4"
          />
...
export class SavingsPageComponent implements OnInit {
  ...
  private loadGoals(): void {
    this.savingService.getGoalsByMonth(this.currentMonth()).subscribe((goals) => {
