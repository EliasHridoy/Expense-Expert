...
#Features:
1. User Authentication: Users can create an account and log in to the application. I prefer passwordless login using email and OTP.
...
4. Expense Draft: User can have some fixed expense like: house rent, wifi bill, electricity bill, donation, investment etc. User can create a draft expense and reuse it in every month. as a result user can see how much expense he has and how much will remain.
